...
router.post('/toggle-availability', auth, (req, res, next) => {
  // Use the same logic as the PUT route
  router.handle({ method: 'PUT', url: '/availability', body: req.body, user: req.user }, res, next);
});
